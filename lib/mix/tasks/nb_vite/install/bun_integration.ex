defmodule Mix.Tasks.NbVite.Install.BunIntegration do
  @moduledoc """
  ...
  # This module is only used when Igniter is available (during installation)
  # Suppress warnings about undefined Igniter modules and parent module functions
  ...
  defp configure_bun_version(igniter) do
    ...
    phoenix_version = if Mix.Tasks.NbVite.Install.is_phoenix_1_8?(igniter), do: "1.8", else: "1.7"
